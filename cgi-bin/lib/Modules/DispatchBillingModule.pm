package Modules::DispatchBillingModule;
...
my %headers = (
   ...
   "numberRequested" => {
        id => "numberRequested",
        displayName => "No of cartons to be Dispatched",
        type => "number",
        mandatory => 1
    },
    "startTime" => {
        id => "startTime",
        displayName => "Job Loaded in Truck at",
        type => "time"
    },
    "endTime" => {
        id => "endTime",
        displayName => "Job Billed at",
        type => "time"
    },
    "factoryGateOutTime" => {
        id => "factoryGateOutTime",
        displayName => "Factory Gate out Time",
        type => "time"    
    }
);
